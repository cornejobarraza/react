    ...
    <div className="Chart">
      ...
      <div className="Data-Summary">
        <div style={{ lineHeight: "0.75rem" }}>
          ...
          <h3 className="dark-brown" style={{ margin: "0.75rem 0 0 0" }}>
            ${listTotal}
          </h3>
        </div>
        <div style={{ lineHeight: "0.2rem", textAlign: "end" }}>
          <h4 className="dark-brown" style={{ fontSize: "1em", fontWeight: "bold", margin: "0 0 0.75rem 0" }}>
            +2.4%
          </h4>
